...
export class BadgeComponent {
  ...
  private readonly variantClasses = {
    primary: {
      badge:
        'inline-flex items-center px-2 py-1 me-2 text-sm font-medium text-blue-800 bg-blue-100 rounded dark:bg-blue-900 dark:text-blue-300',
      dismissBtn:
    ...
    secondary: {
      badge:
        'inline-flex items-center px-2 py-1 me-2 text-sm font-medium text-gray-800 bg-gray-100 rounded dark:bg-gray-700 dark:text-gray-300',
      dismissBtn:
