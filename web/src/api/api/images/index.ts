...
import {
    ...
    createResponseFromDiscriminatorValue,
    type ErrorModel,
    type Response,
 ...
 */
export interface ImagesRequestBuilder
    extends BaseRequestBuilder<ImagesRequestBuilder> {
    /**
     * Get API images
    ...
    get(
        requestConfiguration?:
            | RequestConfiguration<ImagesRequestBuilderGetQueryParameters>
            | undefined
...
export const ImagesRequestBuilderUriTemplate =
    '{+baseurl}/api/images{?limit,offset,youtube_id}';
/**
