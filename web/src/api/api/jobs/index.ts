...
// @ts-ignore
import {
    createCreatedJobFromDiscriminatorValue,
    createErrorModelFromDiscriminatorValue,
    createListJobResponseFromDiscriminatorValue,
    serializeCreatedJob,
    serializeCreateJob,
    type CreatedJob,
    type CreateJob,
...
// @ts-ignore
import {
    JobsItemRequestBuilderNavigationMetadata,
    JobsItemRequestBuilderRequestsMetadata,
    type JobsItemRequestBuilder,
} from './item/index.js';
// @ts-ignore
import {
 ...
 */
export interface JobsRequestBuilder
    extends BaseRequestBuilder<JobsRequestBuilder> {
    /**
    ...
    ): Promise<ListJobResponse[] | undefined>;
    /**
     * Create a new job
 ...
 */
export const JobsRequestBuilderNavigationMetadata: Record<
    Exclude<keyof JobsRequestBuilder, KeysToExcludeForNavigationMetadata>,
    NavigationMetadata
> = {
    byId: {
