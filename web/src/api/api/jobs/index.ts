...
// @ts-ignore
import { createCreatedJobFromDiscriminatorValue, createErrorModelFromDiscriminatorValue, createListJobBodyFromDiscriminatorValue, serializeCreatedJob, serializeCreateJob, type CreatedJob, type CreateJob, type ErrorModel, type ListJobBody } from '../../models/index.js';
// @ts-ignore
...
export interface JobsRequestBuilder extends BaseRequestBuilder<JobsRequestBuilder> {
     ...
     * @returns {Promise<ListJobBody[]>}
     * @throws {ErrorModel} error when the service returns a 4XX or 5XX status code
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<ListJobBody[] | undefined>;
    /**
     * Create a new job
...
export const JobsRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createListJobBodyFromDiscriminatorValue,
    },
    post: {
        uriTemplate: JobsRequestBuilderUriTemplate,
        responseBodyContentType: "application/json",
