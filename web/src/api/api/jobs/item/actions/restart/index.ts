...
// @ts-ignore
import { createErrorModelFromDiscriminatorValue, type ErrorModel } from '../../../../../models/index.js';
// @ts-ignore
 ...
 */
export const RestartRequestBuilderUriTemplate = "{+baseurl}/api/jobs/{id}/actions/restart";
/**
