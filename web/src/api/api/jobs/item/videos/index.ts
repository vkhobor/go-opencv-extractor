...
import {
    ...
    createJobAndVideosFromDiscriminatorValue,
    type ErrorModel,
    type JobAndVideos,
 ...
 */
export interface VideosRequestBuilder
    extends BaseRequestBuilder<VideosRequestBuilder> {
    /**
    ...
    ): Promise<JobAndVideos | undefined>;
    /**
     * Get API jobs by ID videos
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const VideosRequestBuilderUriTemplate =
    '{+baseurl}/api/jobs/{id}/videos';
/**
