...
import {
    ...
    createJobDetailsFromDiscriminatorValue,
    type ErrorModel,
    type JobDetails,
} from '../../../models/index.js';
// @ts-ignore
import {
    ActionsRequestBuilderNavigationMetadata,
    type ActionsRequestBuilder,
} from './actions/index.js';
// @ts-ignore
import {
    type VideosRequestBuilder,
    VideosRequestBuilderRequestsMetadata,
 ...
 */
export interface JobsItemRequestBuilder
    extends BaseRequestBuilder<JobsItemRequestBuilder> {
    /**
 ...
 */
export const JobsItemRequestBuilderNavigationMetadata: Record<
    Exclude<keyof JobsItemRequestBuilder, KeysToExcludeForNavigationMetadata>,
    NavigationMetadata
> = {
    actions: {
